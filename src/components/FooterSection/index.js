          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 col-md-offset-2 text-center fh5co-heading">
                ...
                <p className="info">
                  Based on the current conditions, without reducing respect, it is expected to be able to keep in touch
                   through online media, not by direct physical contact. <br />
                   Please understand.
                </p>
                <p className="info">
